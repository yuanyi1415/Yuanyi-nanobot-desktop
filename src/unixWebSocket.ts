...
// D2: the shell connects to the locally running nanobot gateway over TCP
// (127.0.0.1:8765) instead of a private per-user Unix socket. Keep in sync
// with the GATEWAY_* constants in main.ts.
